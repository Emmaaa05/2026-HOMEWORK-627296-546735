...
public class Stanza {
    ...
    /**
     * Restituisce la lista di stanze adiacenti.
     * @return mappa composta chiavi (nomi delle stanze)
     * ed oggetti (stanze effettive)
     */
    ...
    public String getAttrezzi() {
    	...
    	if(this.attrezzi.isEmpty())
    		return risultato.append("non ci sono attrezzi").toString();
